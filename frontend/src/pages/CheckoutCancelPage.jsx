    ...
    <main className="bg-app min-h-screen">
      <section className="relative pt-32 pb-20 sm:pt-40">
        ...
        <div className="relative mx-auto max-w-xl px-5 text-center">
          ...
          <h1 className="mt-6 font-display text-[40px] text-white font-semibold tracking-tight">Checkout cancelled</h1>
          <p className="mt-3 text-zinc-400">No charge was made. You can try again any time.</p>
